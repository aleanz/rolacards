      ...
      >
        <div className="flex flex-col h-full">
          ...
          <button
            ...
            className="absolute -right-3 top-24 w-6 h-6 rounded-full bg-rola-gray border border-rola-gray/50 flex items-center justify-center text-gray-400 hover:text-white hover:bg-rola-gold hover:border-rola-gold transition-all"
          >
            <ChevronLeft
